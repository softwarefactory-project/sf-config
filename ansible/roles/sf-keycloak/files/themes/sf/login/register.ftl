        ...
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
          <#if !realm.registrationEmailAsUsername>
            ...
            <div class="form-group">
                <div class="${properties.kcLabelWrapperClass!}">
                    <label for="user.attributes.publicKey" class="${properties.kcLabelClass!}">${msg("SSH public key")}</label>
                </div>

                <div class="${properties.kcInputWrapperClass!}">
                    <textarea type="text" class="${properties.kcInputClass!}"  id="user.attributes.publicKey" name="user.attributes.publicKey">${(register.formData['user.attributes.publicKey']!'')}</textarea>
                </div>
            </div>
