...
def main():
    ...
    if os.path.exists(playbook):
        ...
        vp = os.path.join(
            "/root/config/nodepool/virt-images", playbook)
    ...
    os.environ["ANSIBLE_ROLES_PATH"] = \
        "/root/config/nodepool/virt-images/dib-virt-customize"
