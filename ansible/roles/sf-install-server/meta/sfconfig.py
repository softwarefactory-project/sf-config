...
class InstallServer(Component):
    ...
    def configure(self, args, host):
        ...
        if bool(args.sfconfig["tenant-deployment"]):
            ...
            self.configure_tenant_deployment(args, host)
        else:
    ...
    def resolve_tenant_informations(self, args, host):
        ...
        # TODO: rename master_sf_url into master_sf_fqdn
        ...
        try:
            ...
            fail("Couldn't contact master-sf")
        ...
        # Look for tenant default connection name and type
            ...
            for name, values in master_resource.get(
                ...
                if name == args.glue["config_connection_name"]:
                    if values.get("type") == "gerrit":
                        ...
                        # TODO: add app name in resource connection object
